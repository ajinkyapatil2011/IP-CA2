...
const ImageCarousel = () => {
    const slides = [
      {
        ...
        subtitle: 'Welcome to',
        description:
          'Step into a world of luxury and pampering at X Salon, where beauty meets perfection. Our expert stylists and beauticians ensure that you leave looking and feeling your best, every time.',
    ...
    },
    {
        ...
        subtitle: 'Welcome to',
        description:
          'Discover a curated selection of premium beauty products tailored to enhance your natural beauty. From hair care to skincare, shop from the best in beauty at X Salon.',
        buttonText: 'Book Appointment',
        link: '/appointment',  // Navigation link for this slide
    },
    ]
